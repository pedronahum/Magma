...
| **1. DDP MVP (single host)** | ✅ `DeviceMesh` (#11); ✅ `all_reduce` StableHLO op + cross-replica runtime, verified across emulated devices (#12); ⬜ replicate params + gradient all-reduce hook (#13); ⬜ `DistributedSampler` (#14); ⬜ DDP end-to-end (#15) | **M–L** |
